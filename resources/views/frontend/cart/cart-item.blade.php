            ...
            <div class="col-lg-8">
                ...
                <div id="cart-with-items">
                        ...
                        <div class="card-header bg-white py-3">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn btn-link p-0 text-danger" onclick="showEmptyCart()">Clear
                                        Cart</button>
                                </div>
                            </div>
                        </div>
                            ...
                            @foreach ($carts->items as $item)
                                ...
                                <div class="row mb-4 border-bottom pb-4">
                                    <div class="col-md-2 col-4">
                                        <img src="{{ asset($item->product->featured_image) }}" alt="Product"
                                    ...
                                    <div class="col-md-10 col-8">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p class="mb-1 text-muted">{{ $item->product->category->title }} | Brand:
                                                    Test Brand</p>
                                                <p class="mb-3"><span class="badge bg-success">In Stock</span></p>
                                                <div
                                                    class="d-md-none d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <div class="col-md-3 col-5">
                                                <div class="input-group quantity-input mb-3">
                                                    ...
                                                    <input type="text" class="form-control text-center" value="1"
                                                        min="1" onchange="recalculateCart()">
                                                    <button class="btn btn-outline-secondary" type="button"
                                                        onclick="updateCartQuantity(this, 1)">+</button>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-7 d-none d-md-block">
                                                <span style="text-decoration:line-through;color:#999999 !important;"
                                                    class="fw-bold">${{ $item->product->price }}</span>
                                            </div>
                                            <div class="col-md-2 text-md-end">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <span
                                                        class="fw-bold item-total">${{ $item->product->sale_price }}</span>
                                                    <div class="d-none d-md-inline-block">
                                                        <button class="btn btn-sm p-0 ms-2 text-danger"
                                                            onclick="removeCartItem(this)" title="Remove item">
                                                            <i class="bi bi-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        <a href="#" class="continue-shopping"><i class="bi bi-arrow-left me-2"></i>Continue
                            Shopping</a>
                ...
                <div class="card cart-summary shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            ...
                            @if (session('offer_applied'))
                            <span id="cart-total" class="fw-bold fs-5">${{ session('offer_applied.amount') }}</span>
                            @else
                        ...
                        <div class="d-grid gap-2">
                            <form action="{{ route('procced.to.checkout') }}" method="GET">
                                @csrf
                                <input type="hidden" name="shipping_charge" value="{{ $shippingCharge }}">
                                <input type="hidden" name="tax_amount" value="{{ $taxAmount }}">
                                <input type="hidden" name="total_amount" value="{{ (session('offer_applied')) ? (session('offer_applied.amount')) : $totalAmount }}">
                                <input type="hidden" name="discount_amount" value="{{ (session('offer_applied')) ? (session('offer_applied.discount')) : 0 }}">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom">
                            <img src="/api/placeholder/80/80" alt="Product" class="img-fluid rounded me-3"
                                style="width: 60px; height: 60px; object-fit: cover;">
                            <div>
                                <h6 class="mb-1"><a href="#" class="product-link">Lightweight Jacket</a></h6>
                                <div class="text-muted small mb-1">$69.99</div>
                                <button class="btn btn-sm btn-outline-primary" onclick="quickAddToCart(this)">Add to
                                    Cart</button>
                            </div>
                        </div>
